...
let seuilMensualite = revenuMensuel * 0.3;

console.log(mensualiteEstimee);

if (seuilMensualite >= mensualiteEstimee)
    console.log("Prêt accordé. Mensualité :" + mensualiteEstimee +  " MAD");
else if (revenuMensuel > 10000)
console.log("augmenter la duree");
else
